...
form.addEventListener("submit", function (e) {
  ...
  const value = parseInt(amount.value); // get integer value of input
  const random = Math.floor(Math.random() * text.length); // get random number between 0 and length of text array
